...
<<<<<<< Updated upstream
To modify the approval threshold, adjust the rule in the check_business_details state in your workflow definition. This allows for manual review under new enrichment data conditions.
