...
<CodeBlock 
  lang="bash"
  code={`pnpm add @ballerine/web-sdk`}
/>

<CodeBlock 
  lang="bash"
  code={`yarn add @ballerine/web-sdk`}
/>

<CodeBlock 
  lang="bash"
  code={`npm install @ballerine/web-sdk`}
/>
...
Next, we'll go to `src/main.ts`, import `flows` from `@ballerine/web-sdk`, create our flow, and mount it.
...
- <a href="https://github.com/ballerine-io/ballerine/tree/main/sdks/web-sdk" target="_blank">SDK source code</a>
