...
<PackageManagersTabs
    code={{
        pnpm: `pnpm create vite ballerine-kyc-flow --template vanilla-ts`,
        yarn: `yarn create vite ballerine-kyc-flow --template vanilla-ts`,
        npm: `npm create vite ballerine-kyc-flow -- --template vanilla-ts`,
    }}
/>
