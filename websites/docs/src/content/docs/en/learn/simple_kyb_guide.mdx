...
This guide will walk you through all the necessary steps   And make sure to run the `api-flow-example` script to start the Workflow service and the Backoffice.
