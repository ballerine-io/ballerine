...
The backoffice should be running on https://<backoffice_url>
The collection flow on https://kyb_url and
The workflow service will be accepting calls at https://<workflow_svc_url>.
