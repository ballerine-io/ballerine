...
description: This guide provides a step-by-step process for setting up and running the Ballerine stack on Kubernetes cluster.
---
...
Ballerine is a collection of services like workflow-service, and backoffice.
