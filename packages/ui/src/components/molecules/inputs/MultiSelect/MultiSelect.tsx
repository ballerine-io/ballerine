      ...
      <ClickAwayListener onClickAway={handleOutsidePopupClick}>
        <Command onKeyDown={handleKeyDown} className="overflow-visible">
          <PopoverTrigger asChild>
            <div
              className={ctw(
                'border-input ring-offset-background focus-within:ring-ring min-10 group flex w-full items-center rounded-md border py-2 text-sm focus-within:ring-1 focus-within:ring-offset-1',
                { 'pointer-events-none opacity-50': disabled },
              )}
            >
              <div
                className="flex w-full flex-wrap gap-2 px-2"
                tabIndex={0}
