...
import { __commonJS2 as __commonJS, __toESM, __toESM2 } from './chunk-AS2AMEUR.js';
        ...
        var PLUGINNAME = 'OverlayScrollbars',
          ...
          EASING = (function () {
            ...
            return {
              ...
              easeOutBack: function (x, t, b, c, d, s) {
                return (
                  (s = s || _easingsMath.o), c * ((t = t / d - 1) * t * ((s + 1) * t + s) + 1) + b
                );
              },
          ...
          FRAMEWORK = (function () {
            ...
            function each(obj, callback) {
              var i = 0;
              if (isArrayLike(obj))
                for (; i < obj[LEXICON.l] && callback.call(obj[i], i, obj[i]) !== !1; i++);
              else for (i in obj) if (callback.call(obj[i], i, obj[i]) === !1) break;
              return obj;
            }
            function isArrayLike(obj) {
              ...
              return isFunction(t)
                ...
                : t == TYPES.a ||
                    length2 === 0 ||
                    (_type(length2) == TYPES.n && length2 > 0 && length2 - 1 in obj);
            }
            ...
            function animate(el, props, options, easing, complete, guaranteedNext) {
              ...
              if (isEmptyObject(to)) guaranteedNext && startNextAnimationInQ(animObj);
                ...
                if (
                  (qPos === -1 && ((qPos = animObj.q[LEXICON.l]), animObj.q.push(qObj)), qPos === 0)
                )
                  if (duration > 0)
            ...
            return (
              (FakejQuery[LEXICON.p] = {
                  ...
                  for (
                    this.each(function () {
                      (parent = this.parentNode),
                        inArray(parent, parents) === -1 && parents.push(parent);
                    }),
                      i = 0;
                    i < parents[LEXICON.l];
                    i++
                    ...
                    for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                      if (
                        ...
                        (finalValue = stripAndCollapse(cur)),
                          curValue !== finalValue && (elem.className = finalValue);
                      }
                  }
                  return this;
                },
                ...
                offset: function () {
                  var el = this[0],
                    rect = el[LEXICON.bCR](),
                    scrollLeft = window2.pageXOffset || document.documentElement[_strScrollLeft],
                    scrollTop = window2.pageYOffset || document.documentElement[_strScrollTop];
          ...
          INSTANCES = (function () {
            ...
            return function (target, instance) {
              ...
              if (instance) (target[_instancePropertyString] = instance), _targets.push(target);
                ...
                if (index > -1)
                  if (argLen > 1) delete target[_instancePropertyString], _targets.splice(index, 1);
            ...
            var _plugin,
              ...
              _pluginsOptions = (function () {
                var type = COMPATIBILITY.type,
                  ...
                  updateOnLoadTemplate = [['img'], [TYPES.s, TYPES.a, TYPES.z]],
                  inheritedAttrsTemplate = [
                    ['style', 'class'],
                    [TYPES.s, TYPES.a, TYPES.z],
                  ],
                  resizeAllowedValues = 'n:none b:both h:horizontal v:vertical',
                  overflowBehaviorAllowedValues =
                    'v-h:visible-hidden v-s:visible-scroll s:scroll h:hidden',
                  scrollbarsVisibilityAllowedValues = 'v:visible h:hidden a:auto',
                  scrollbarsAutoHideAllowedValues = 'n:never s:scroll l:leave m:move',
                          ...
                          if (template2[LEXICON.hOP](prop) && data[LEXICON.hOP](prop)) {
                            ...
                            if (
                              ...
                              (validatedOptions2[prop] = {}),
                                ...
                                FRAMEWORK.each(
                                  [data, validatedOptions2, validatedOptionsPrepared2],
                                ...
                                if (
                                  ...
                                  for (
                                    ...
                                    for (
                                      ...
                                      if (
                                        dataValue === restrictedStringValuesPossibilitiesSplit[j]
                                      ) {
                                        isValid = !0;
                                        break;
                                      }
                              ...
                              isValid
                                ? ((isDiff = dataValue !== dataDiffValue),
                                  isDiff && (validatedOptions2[prop] = dataValue),
                                  (isRestrictedValue
                                    ? inArray(
                                        dataDiffValue,
                                        restrictedStringValuesPossibilitiesSplit,
                                    ...
                                    : isDiff) &&
                                    (validatedOptionsPrepared2[prop] = isRestrictedValue
                                      ? mainPossibility
                                      : dataValue))
                                : writeErrors &&
                                  console.warn(
              ...
              var nativeScrollbarSize = calcNativeScrollbarSize(scrollbarDummyElement0),
                ...
                msie = (function () {
                  ...
                  return (
                    msie2 > 0
                      ? (result = parseIntFunc(
                          ua[strSubString](msie2 + 5, ua[strIndexOf]('.', msie2)),
                          10,
                        ))
                      : trident > 0
                      ? (result = parseIntFunc(
                ...
                (_base.remove = function (instance) {
                  ...
                  index > -1 &&
                    ...
                    _loopingInstances[_strLength] === 0 &&
                      ...
                      _loopID !== undefined2 && (COMPATIBILITY.cAF()(_loopID), (_loopID = -1))));
                });
            }
            function OverlayScrollbarsInstance(
              ...
              function setupResponsiveEventListener(
                ...
                var collected = COMPATIBILITY.isA(eventNames) && COMPATIBILITY.isA(listener),
                  method = remove2 ? 'removeEventListener' : 'addEventListener',
                  ...
                  if (onElementResizedCallback) {
                    if (_supportResizeObserver) {
                      var element = targetElement
                          ...
                          .contents()[0],
                        observer = (element[_strResizeObserverProperty] = new resizeObserver(
                          callback,
                        ));
                    ...
                    (_mutationObserverContentCallback = function (mutations) {
                      ...
                      return (
                        _initialized &&
                          ...
                          (each(mutations, function () {
                            return (
                              (mutation = this), (doUpdate = isUnknownMutation(mutation)), !doUpdate
                            );
                          }),
                          doUpdate &&
                ...
                if (
                  ...
                  if (
                    ...
                    classNameChanged &&
                      ...
                      addClass(
                        _hostElement,
                        className !== undefined2 && className !== null && className.length > 0
                          ? className
                          : _classNameThemeNone,
                      )),
                    autoUpdateChanged &&
                      (autoUpdate === !0 || (autoUpdate === null && _autoUpdateRecommended)
                    ...
                    widthAutoObserverDetection =
                      _sizeAutoObserverAdded && _hostElement.css(_strFloat) !== 'none'
                        ? MATH.round(
                          ...
                          (paddingAbsolute ? !0 : _hostElementNative[LEXICON.cW] - _paddingX > 0)
                        : !1;
                  ...
                  var widthAuto =
                    ...
                    updateBorderX = (widthAuto && _isBorderBox) || !_isBorderBox,
                    updateBorderY = (heightAuto && _isBorderBox) || !_isBorderBox,
                  ...
                  if (
                        ...
                        hasOverflow[xy] && hideOverflow[xy + 's']
                          ? ((viewportElementCSS[strOverflow + XY] = _strScroll),
                            ignoreOverlayScrollbarHiding || _nativeScrollbarStyling
                              ? reset()
                              : ((viewportElementCSS[strDirection] = -(_nativeScrollbarIsOverlaid[
                                  xy
                                ]
                                  ? _overlayScrollbarDummySize[xy]
                    ...
                    if (
                      ...
                      if (textareaInfo) {
                        var textareaRowsChanged =
                          ...
                          cursorIsLastPosition = cursorPos >= cursorMax && _textareaHasFocus,
                    ...
                    var scrollbarsVisibilityVisible = scrollbarsVisibility === 'v',
                      scrollbarsVisibilityHidden = scrollbarsVisibility === 'h',
              ...
              function setupStructureEvents() {
                ...
                function contentOnTransitionEnd(event) {
                  _autoUpdateCache !== !0 &&
                    ((event = event.originalEvent || event),
                    isSizeAffectingCSSProperty(event.propertyName) && _base.update(_strAuto));
                }
                ...
                function documentDragMove(event) {
                  if (onMouseTouchDownContinue(event)) {
                    var trackLength = scrollbarVarsInfo._trackLength,
                      ...
                      scrollDeltaPercent = scrollRaw / (trackLength - handleLength),
                ...
                function documentMouseTouchUp(event) {
                  if (
                    ...
                    trackTimeout !== undefined2 &&
                      (_base.scrollStop(), clearTimeout(trackTimeout), (trackTimeout = undefined2)),
                    event)
                  ) {
              ...
              function isHTMLElement(o) {
                var strOwnerDocument = 'ownerDocument',
                  ...
                  wnd = (o && o[strOwnerDocument] && o[strOwnerDocument].parentWindow) || window2;
...
`),
                    ...
                    textareaCurrentCursorRowSplit = textareaValue.substr(0, textareaCursorPosition)
                      .split(`
`),
                    widestRow = 0,
                    textareaLastCol = 0,
                      ...
                      : (function () {
                          ...
                          if (FRAMEWORK.isPlainObject(classesOrAttrs))
                            for (key in classesOrAttrs)
                              attrs +=
                                (key === 'c' ? 'class' : key) + '="' + classesOrAttrs[key] + '" ';
                          return attrs;
                        })()
                    : _strEmpty) +
                  '>' +
              ...
              (_base.sleep = function () {
                ...
                (_base.scroll = function (coordinates, duration, easing, complete) {
                  ...
                  function getRawScroll(isX, coordinates2) {
                    ...
                    if (
                      ((coordinates2 =
                        type(coordinates2) == TYPES.s || type(coordinates2) == TYPES.n
                  ...
                  function getFinalScroll(isX, rawScroll) {
                    ...
                    if (
                      (isString
                        ...
                        : (amount = rawScroll),
                      amount !== undefined2 && !isNaN(amount) && type(amount) == TYPES.n)
                    ) {
                            ...
                            scrollNever
                              ...
                              : doNotScroll[xy] ||
                                ((blockIsNearest || scrollIfNeeded) &&
                                  ((doNotScroll[xy] = scrollIfNeeded ? isInView : !1),
                                  (blockIsEnd =
                                    elSize < vpSize
                  ...
                  if (COMPATIBILITY.type(extension) == TYPES.f)
                    ...
                    for (; i < _pluginsExtensions[LEXICON.l]; i++)
                      if (_pluginsExtensions[i].name === extensionName)
                        ...
                        else return FRAMEWORK.extend(!0, {}, _pluginsExtensions[i]);
                }
              }),
              _plugin
            );
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement('div', { className: 'os-content' }, children),
          ),
        ),
        import_react.default.createElement(
          'div',
