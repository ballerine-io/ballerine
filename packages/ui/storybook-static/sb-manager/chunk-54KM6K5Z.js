...
import { emotion_styled_browser_esm_default, logger, scope } from './chunk-F3MVQVF6.js';
...
var ActionBar = ({ actionItems, ...props }) =>
  ...
  ScrollArea = emotion_styled_browser_esm_default(Scroller)(
    ({ vertical }) => (vertical ? { overflowY: 'auto', height: '100%' } : { overflowY: 'hidden' }),
    ({ horizontal }) =>
      horizontal ? { overflowX: 'auto', width: '100%' } : { overflowX: 'hidden' },
  );
