  ...
  var ue = (e, t, s, o) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of ie(t))
        !se.call(e, i) &&
          i !== s &&
          F(e, i, { get: () => t[i], enumerable: !(o = oe(t, i)) || o.enumerable });
    return e;
  };
  var de = (e, t, s) => (
    (s = e != null ? ne(ae(e)) : {}),
    ue(t || !e || !e.__esModule ? F(s, 'default', { value: e, enumerable: !0 }) : s, e)
  );
  var c = L(() => {});
  var f = L(() => {});
  var m = L(() => {});
  var Q = le((J, D) => {
    ...
    (function (e) {
      ...
      return (function o(i, g, l) {
        ...
        for (var r = typeof C == 'function' && C, u = 0; u < l.length; u++) n(l[u]);
        return n;
      })(
        {
          1: [
            ...
            function (o, i, g) {
              ...
              i.exports = function (a) {
                ...
                return function (b) {
                  var p = function () {
                    ...
                    for (I = 0; I < O; I++) {
                      if (((B[I] = { cacheItem: y, arg: arguments[I] }), y.has(arguments[I]))) {
                        y = y.get(arguments[I]);
                        continue;
                      }
                      (x = !1), (S = new l(!1)), y.set(arguments[I], S), (y = S);
                    }
                    return (
                      x && (y.has(arguments[O]) ? (A = y.get(arguments[O])) : (x = !1)),
                      x || ((A = b.apply(null, arguments)), y.set(arguments[O], A)),
                      a > 0 &&
                  ...
                  return (p.limit = a), (p.wasMemoized = !1), (p.cache = h), (p.lru = d), p;
                };
              };
              function n(a, h) {
                var d = a.length,
              ...
              function r(a) {
                ...
                for (
                  ...
                  p >= 0 && ((d = a[p]), (b = d.cacheItem.get(d.arg)), !b || !b.size);
                  p--
                )
    ...
    var i = o.reduce(function (n, r) {
      ...
      return u
        ? n.concat(
            u.map(function (a) {
              var h, d;
              return (d = (h = a.match(/[\t ]/g)) === null || h === void 0 ? void 0 : h.length) !==
                null && d !== void 0
                ? d
                : 0;
            }),
...
`)),
  ...
  N.register(R, () => {
    N.add(R, {
      ...
      render: () => T.createElement(w, null, T.createElement(pe, null), T.createElement(he, null)),
    });
  });
} catch (e) {
