try {
  ...
  var me = (e, t, o, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let p of pe(t))
        !ue.call(e, p) &&
          p !== o &&
          H(e, p, { get: () => t[p], enumerable: !(n = le(t, p)) || n.enumerable });
    return e;
  };
  var ce = (e, t, o) => (
    (o = e != null ? ae(he(e)) : {}),
    me(t || !e || !e.__esModule ? H(o, 'default', { value: e, enumerable: !0 }) : o, e)
  );
  var m = M(() => {});
  var c = M(() => {});
  var f = M(() => {});
  var te = de((ee, V) => {
    ...
    (function (e) {
      ...
      return (function n(p, g, h) {
        ...
        for (var i = typeof R == 'function' && R, x = 0; x < h.length; x++) r(h[x]);
        return r;
      })(
        {
          1: [
          ...
          2: [
            function (n, p, g) {
              ...
              (h.prototype.get = function (r) {
                var i;
                if (this.lastItem && this.isEqual(this.lastItem.key, r)) return this.lastItem.val;
                ...
                (h.prototype.set = function (r, i) {
                  ...
                  return this.lastItem && this.isEqual(this.lastItem.key, r)
                    ...
                    : ((x = this.indexOf(r)),
                      x >= 0
                        ? ((this.lastItem = this.list[x]), (this.list[x].val = i), this)
                ...
                (h.prototype.has = function (r) {
                  ...
                  return this.lastItem && this.isEqual(this.lastItem.key, r)
                    ? !0
                    : ((i = this.indexOf(r)), i >= 0 ? ((this.lastItem = this.list[i]), !0) : !1);
                }),
                ...
                (h.prototype.indexOf = function (r) {
                  var i;
                  for (i = 0; i < this.size; i++) if (this.isEqual(this.list[i].key, r)) return i;
                  return -1;
                }),
            ...
            function (n, p, g) {
              ...
              p.exports = function (s) {
                ...
                return function (b) {
                  var l = function () {
                    ...
                    for (O = 0; O < I; O++) {
                      if (((k[O] = { cacheItem: a, arg: arguments[O] }), a.has(arguments[O]))) {
                        a = a.get(arguments[O]);
                        continue;
                      }
                      (E = !1), (d = new h(!1)), a.set(arguments[O], d), (a = d);
                    }
                    return (
                      E && (a.has(arguments[I]) ? (C = a.get(arguments[I])) : (E = !1)),
                      E || ((C = b.apply(null, arguments)), a.set(arguments[I], C)),
                      s > 0 &&
                  ...
                  return (l.limit = s), (l.wasMemoized = !1), (l.cache = y), (l.lru = u), l;
                };
              };
              function r(s, y) {
                var u = s.length,
              ...
              function i(s) {
                ...
                for (
                  ...
                  l >= 0 && ((u = s[l]), (b = u.cacheItem.get(u.arg)), !b || !b.size);
                  l--
                )
  ...
  var ye = (0, D.default)(50)(e => [
    ...
    _e = A.div(({ theme: e }) => ({ fontSize: e.typography.size.s2 - 1, marginLeft: 10 })),
    Oe = (e, t, o) => {
    ...
    Ee = $(
      re(({ theme: e }) => {
        ...
        r.find(d => d.id === n) ||
          ...
          L(() => {
            h({ selected: n || (t[g.selected] ? g.selected : P.id), isRotated: o === 'landscape' });
          }, [o, n]);
        let { selected: y, isRotated: u } = g,
          b = r.find(d => d.id === y) || r.find(d => d.id === n) || r.find(d => d.default) || P,
          l = j(),
          ...
          p || Object.entries(t).length === 0
            ...
            : S.createElement(
                ...
                S.createElement(
                  ...
                  {
                    placement: 'top',
                    tooltip: ({ onHide: d }) => S.createElement(oe, { links: we(r, b, h, g, d) }),
                  ...
                  S.createElement(
                    ...
                    a ? S.createElement(_e, null, u ? `${b.title} (L)` : `${b.title} (P)`) : null,
                  ),
                ),
                a
                  ? S.createElement(
                      ...
                      S.createElement(se, { title: 'Viewport width' }, a.width.replace('px', '')),
                      S.createElement(
                        B,
                        {
                          key: 'viewport-rotate',
                      ...
                      S.createElement(se, { title: 'Viewport height' }, a.height.replace('px', '')),
                    )
                  : null,
              )
        );
