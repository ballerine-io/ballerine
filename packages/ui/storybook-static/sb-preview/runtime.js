  ...
  '../../node_modules/qs/lib/stringify.js'(exports, module) {
    ...
    var getSideChannel = require_side_channel(),
      ...
      stringify2 = function stringify3(
        ...
        for (
          var adjustedPrefix =
              commaRoundTrip && isArray2(obj) && obj.length === 1 ? prefix + '[]' : prefix,
            j = 0;
          j < objKeys.length;
          ++j
        ) {
...
var generateRandomId = () => Math.random().toString(16).slice(2),
  Channel = class {
    ...
    emit(eventName, ...args2) {
      ...
      let handler = () => {
        this.transport && this.transport.send(event, options2), this.handleEvent(event);
      };
  ...
  PostmsgTransport = class {
    ...
    getCurrentFrames() {
      return this.config.page === 'manager'
        ? Array.from(document.querySelectorAll('[data-is-storybook="true"]')).map(
            e => e.contentWindow,
          )
        : scope && scope.parent
        ? [scope.parent]
    ...
    getLocalFrame() {
      return this.config.page === 'manager'
        ? Array.from(document.querySelectorAll('#storybook-preview-iframe')).map(
            e => e.contentWindow,
          )
        : scope && scope.parent
        ? [scope.parent]
...
var B = Object.create,
  ...
  P = (r, e, t) => (
    (t = r != null ? B(h(r)) : {}),
    E(e || !r || !r.__esModule ? R(t, 'default', { value: r, enumerable: !0 }) : t, r)
  ),
  x = I(T => {
...
var getQueryString = ({ selection, extraParams }) => {
  ...
  getSelectionSpecifierFromPath = () => {
    let query = import_qs3.default.parse(document2.location.search, { ignoreQueryPrefix: !0 }),
...
function insertScript($script, callback, $scriptRoot) {
  ...
  (scriptEl.type = $script.type === 'module' ? 'module' : 'text/javascript'),
    ...
    $scriptRoot ? $scriptRoot.appendChild(scriptEl) : document3.head.appendChild(scriptEl),
