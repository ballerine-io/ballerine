...
function v() {
  if (
    !a &&
    ((a = typeof crypto < 'u' && crypto.getRandomValues && crypto.getRandomValues.bind(crypto)), !a)
  )
    throw new Error(
...
const A = typeof crypto < 'u' && crypto.randomUUID && crypto.randomUUID.bind(crypto),
  d = { randomUUID: A };
function R(t, e, r) {
    ...
    if (E(t)) {
      ...
      return (
        typeof n == 'object' &&
          ...
          Object.defineProperty(e, 'view', { ...r, value: Object.create(n.constructor.prototype) }),
        e
      );
    }
    return t;
    ...
    n = function (...i) {
      let c = U.getChannel(),
        ...
        O = {
          ...
          count: 0,
          data: { name: t, args: m },
          options: { ...r, maxDepth: s + (r.depth || 3), allowFunction: r.allowFunction || !1 },
        };
      c.emit(D, O);
    };
  ...
  w = t => {
    ...
    return (n != null && n.disable) || !r
      ...
      : Object.entries(r)
          .filter(([i, c]) => !!c.action)
          .reduce(
            (i, [c, p]) => (g(c, e) && (i[c] = y(typeof p.action == 'string' ? p.action : c)), i),
            {},
          );
  },
  _ = [w, T];
