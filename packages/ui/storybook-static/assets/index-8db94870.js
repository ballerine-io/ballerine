import { g as D } from './_commonjsHelpers-042e6b4d.js';
function T(e, t) {
        ...
        : o != null &&
          (b(o) &&
            (o = G(
              o,
              n +
                (!o.key || (s && s.key === o.key) ? '' : ('' + o.key).replace(w, '$&/') + '/') +
                e,
            )),
          t.push(o)),
      1
...
var l = { current: null },
  h = { transition: null },
  Q = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: E };
r.Children = {
  map: d,
...
//# sourceMappingURL=index-8db94870.js.map
