...
function Z() {
  ...
  A(m.canvas, m.context, { width: e, height: t }), (m.width = e), (m.height = t);
}
function U() {
...
function E(e, t, o, l) {
  let i = [];
  o.forEach((n, r) => {
    let f = l && n.position === 'center' ? ot(e, t, n) : tt(e, t, n, i[r - 1], l);
    i[r] = f;
  });
}
function it(e, t, o, l) {
...
var S = { margin: '#f6b26ba8', border: '#ffe599a8', padding: '#93c47d8c', content: '#6fa8dca8' },
  R = 30;
function p(e) {
...
function nt(e) {
  ...
  let y = { top: p(a), bottom: p(s), left: p(h), right: p(g) },
    ...
    L = { top: o - y.top, bottom: n + y.bottom, left: l - y.left, right: i + y.right };
  return {
    margin: y,
    padding: N,
    border: q,
...
function ft(e, { margin: t, width: o, height: l, top: i, left: n, bottom: r, right: f }) {
...
function at(e, { border: t, width: o, height: l, top: i, left: n, bottom: r, right: f }) {
...
function st(e, { padding: t, border: o, width: l, height: i, top: n, left: r }) {
  let f = l - o.left - o.right - t.left - t.right,
    a = i - t.top - t.bottom - o.top - o.bottom;
  return (
