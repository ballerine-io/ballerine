import { s as Xn } from './index-d475d2ea.js';
import { R as Le, r as Pe } from './index-8db94870.js';
import {
  u as Ur,
  r as Hn,
  a as Qn,
  ...
  T as Wr,
  j as ns,
} from './_getPrototype-f17fb99d.js';
import { g as pt, c as lt, a as ss } from './_commonjsHelpers-042e6b4d.js';
import { d as as } from './index-356e4a49.js';
import { f as _i, g as Ei, h as os, j as zr } from './_baseIteratee-6b4700d7.js';
import './index-8ce4a492.js';
var { FRAMEWORK_OPTIONS: Yt } = Xn,
  Bu = (e, t) => {
    ...
    return Le.createElement(i, { ...e });
  },
  us = class extends Pe.Component {
    constructor() {
  ...
  $r = Yt != null && Yt.strictMode ? Pe.StrictMode : Pe.Fragment;
async function Du(
  { storyContext: e, unboundStoryFn: t, showMain: r, showException: i, forceRemount: s },
  a,
) {
  let c = Le.createElement(us, { showMain: r, showException: i }, Le.createElement(t, { ...e })),
    f = $r ? Le.createElement($r, null, c) : c;
  return s && Ur(a), await Hn(f, a), () => Ur(a);
}
var Ci = { exports: {} },
...
(function (e) {
  (function t(r) {
    ...
    (S.prototype.traverse = function (x, _) {
      var k, B, R, G, q, D, H, ne, ue, ie, Q, be;
      for (
        ...
        if (R.node) {
          ...
          if ((k.push(be), B.push(R), this.__state === f || D === f)) continue;
      ...
      (S.prototype.replace = function (x, _) {
        var k, B, R, G, q, D, H, ne, ue, ie, Q, be, we;
        function M(je) {
          var tt, rt, K, ge;
          if (je.ref.remove()) {
            for (rt = je.ref.key, ge = je.ref.parent, tt = k.length; tt--; )
              if (((K = k[tt]), K.ref && K.ref.parent === ge)) {
                if (K.ref.key < rt) break;
                --K.ref.key;
              }
          }
        }
        for (
          this.__initialize(x, _),
            ...
            B = this.__leavelist,
            be = { root: x },
            D = new E(x, null, null, new b(be, 'root')),
            k.push(D),
            B.push(D);
          k.length;
          ...
          if (
            ...
            (this.__state === p || q === p) && (M(D), (D.node = null)),
            this.__state === c || q === c)
          )
            return be.root;
          if (((R = D.node), !!R && (k.push(Q), B.push(D), !(this.__state === f || q === f)))) {
            ...
            for (H = ue.length; (H -= 1) >= 0; )
              if (((we = ue[H]), (ie = R[we]), !!ie))
                if (Array.isArray(ie)) {
                  for (ne = ie.length; (ne -= 1) >= 0; )
                    if (ie[ne]) {
                      if (v(G, ue[H])) D = new E(ie[ne], [we, ne], 'Property', new b(ie, ne));
                      else if (C(ie[ne])) D = new E(ie[ne], [we, ne], null, new b(ie, ne));
                      else continue;
                      k.push(D);
                    }
                } else C(ie) && k.push(new E(ie, we, null, new b(R, we)));
          }
        }
        return be.root;
      });
...
function Es() {
  return (
    ni ||
      ((ni = 1),
      (nt.SourceMapGenerator = Ni().SourceMapGenerator),
      (nt.SourceMapConsumer = Ss().SourceMapConsumer),
      (nt.SourceNode = _s().SourceNode)),
    nt
  );
}
const Cs = 'escodegen',
  As = 'ECMAScript code generator',
  ws = 'http://github.com/estools/escodegen',
  ks = 'escodegen.js',
  Ts = { esgenerate: './bin/esgenerate.js', escodegen: './bin/escodegen.js' },
  ...
  Os = { type: 'git', url: 'http://github.com/estools/escodegen.git' },
  Rs = { estraverse: '^5.2.0', esutils: '^2.0.2', esprima: '^4.0.1', optionator: '^0.8.1' },
  Fs = { 'source-map': '~0.6.1' },
  Ms = {
    acorn: '^7.3.1',
    bluebird: '^3.4.7',
...
`,
    ...
    function bt(n, u) {
      ...
      for (o in u)
        u.hasOwnProperty(o) &&
          ((l = u[o]), d(l) ? (d(n[o]) ? bt(n[o], l) : (n[o] = bt({}, l))) : (n[o] = l));
      return n;
    }
    function Bn(n) {
      var u, o, l, d, w;
    ...
    function Wn(n, u) {
      ...
      for (
        ...
        (J = Z(pe(o[l].slice(I)))), (o[l] = x ? J.join('') : J);
      return (
        (f = F),
        o.join(`
`)
...
`),
    ...
    function Br(n, u) {
      var o, l, d, w, T, I, F, J, ce, Ue, Xe, jr, qr, ke;
...
`,
          ...
          for (
            ...
            (d = n.trailingComments[o]),
              T ? (o === 0 ? (u = [u, p]) : (u = [u, I]), u.push(Ie(d, I))) : (u = [u, pe(Ie(d))]),
              o !== l - 1 &&
                !he(Z(u).toString()) &&
                (u = [
                  u,
...
` && d++;
    ...
    function Vr(n) {
      var u = n.value,
        o = '';
      return u.async && (o += it(u, !n.computed)), u.generator && (o += St(u) ? '*' : ''), o;
    }
    (oe.prototype.generatePattern = function (n, u, o) {
      return n.type === t.Identifier ? ye(n) : this.generateExpression(n, u, o);
    }),
      (oe.prototype.generateFunctionParams = function (n) {
        ...
        if (
          ...
          l = [it(n, !0), ye(n.params[0])];
        else {
          for (
            l = n.type === t.ArrowFunctionExpression ? [it(n, !1)] : [],
              l.push('('),
              n.defaults && (d = !0),
              u = 0,
              o = n.params.length;
            ...
            d && n.defaults[u]
              ...
              u + 1 < o && l.push(',' + v);
          n.rest && (n.params.length && l.push(',' + v), l.push('...'), l.push(ye(n.rest))),
            l.push(')');
        }
        return l;
      }),
        ...
        return (
          ...
          n.expression
            ? (u.push(v),
              ...
              u.push(o))
            : u.push(this.maybeBlock(n.body, Fn)),
          u
        );
      }),
            ...
            u.left.type === t.VariableDeclaration
              ? ae(function () {
                  l.push(u.left.kind + fe()),
                    l.push(d.generateStatement(u.left.declarations[0], xt));
                })
...
` && (d = ['{']),
                  d.push(l)));
              var T, I, F, J;
              for (J = K, u & ue && (J |= ie), T = 0, I = n.body.length; T < I; ++T)
                k &&
                  (T === 0 &&
                    (n.body[0].leadingComments &&
                      ...
                      l[0] ===
                        `
` && (d = ['{'])),
                    n.body[0].leadingComments || Je(n.range[0], n.body[0].range[0], d)),
                  T > 0 &&
                    !n.body[T - 1].trailingComments &&
                    !n.body[T].leadingComments &&
                    Je(n.body[T - 1].range[1], n.body[T].range[0], d)),
                  T === I - 1 && (J |= Q),
                  ...
                  k &&
                    T === I - 1 &&
                    (n.body[T].trailingComments || Je(n.body[T].range[1], n.range[1], d));
            }),
            d.push(pe('}')),
            d
          );
        ...
        ClassDeclaration: function (n, u) {
          ...
          return (
            ...
            n.superClass &&
              ...
              (o = U(o, l))),
            o.push(v),
            o.push(this.generateStatement(n.body, ge)),
            o
          );
        },
        DirectiveStatement: function (n, u) {
          return A.raw && n.raw ? n.raw + this.semicolon(u) : qn(n.directive) + this.semicolon(u);
        },
        DoWhileStatement: function (n, u) {
          var o = U('do', this.maybeBlock(n.body, K));
          return (
        ...
        CatchClause: function (n, u) {
          ...
          return (
            ...
            o.push(this.maybeBlock(n.body, K)),
            o
          );
        },
...
`),
        ...
        SwitchStatement: function (n, u) {
          ...
          if (
            ...
            for (T = K, d = 0, w = n.cases.length; d < w; ++d)
              d === w - 1 && (T |= Q),
                (l = pe(this.generateStatement(n.cases[d], T))),
                o.push(l),
                he(Z(l).toString()) || o.push(C);
          return o.push(pe('}')), o;
        },
              ...
              for (
                n.test
                  ...
                  w &&
                    ...
                    ((l = I.maybeBlock(n.consequent[0], K)), o.push(l), (d = 1)),
                  d !== w && !he(Z(o).toString()) && o.push(C),
                  T = K;
                d < w;
                ++d
              )
                d === w - 1 && u & Q && (T |= Q),
                  ...
                  o.push(l),
                  d + 1 !== w && !he(Z(l).toString()) && o.push(C);
            }),
            o
          );
        },
        IfStatement: function (n, u) {
          ...
          return (
            ...
            d && (l |= Q),
            n.alternate
              ? (o.push(this.maybeBlock(n.consequent, K)),
        ...
        ForStatement: function (n, u) {
          ...
          return (
              ...
              (o = ['for' + v + '(']),
                n.init
                  ? n.init.type === t.VariableDeclaration
                    ? o.push(l.generateStatement(n.init, xt))
                    : (o.push(l.generateExpression(n.init, r.Sequence, be)), o.push(';'))
                  : o.push(';'),
            ...
            o.push(this.maybeBlock(n.body, u & Q ? ge : K)),
            o
          );
        },
        ForInStatement: function (n, u) {
          return this.generateIterationForStatement('in', n, u & Q ? ge : K);
        },
        ForOfStatement: function (n, u) {
          return this.generateIterationForStatement('of', n, u & Q ? ge : K);
        },
        LabeledStatement: function (n, u) {
          return [n.label.name + ':', this.maybeBlock(n.body, u & Q ? ge : K)];
        },
...
`
            ...
            !L && d === w - 1 && (T |= Q),
              k &&
                (d === 0 && (n.body[0].leadingComments || Je(n.range[0], n.body[d].range[0], o)),
                d > 0 &&
                  !n.body[d - 1].trailingComments &&
                  !n.body[d].leadingComments &&
                  Je(n.body[d - 1].range[1], n.body[d].range[0], o)),
              ...
              k &&
                d === w - 1 &&
                (n.body[d].trailingComments || Je(n.body[d].range[1], n.range[1], o));
          return o;
        },
      ...
      (oe.Expression = {
        ...
        ConditionalExpression: function (n, u, o) {
          return (
            ...
            le(
              [
                this.generateExpression(n.test, r.LogicalOR, o),
                v + '?' + v,
        ...
        LogicalExpression: function (n, u, o) {
          return this.BinaryExpression(n, u, o);
        },
        BinaryExpression: function (n, u, o) {
          ...
          return (
            ...
            (n.operator.slice(-1) === '<' && I.toString().slice(0, 3) === '!--')
              ? (l.push(fe()), l.push(I))
              : (l = U(l, I)),
            n.operator === 'in' && !(o & D) ? ['(', l, ')'] : le(l, T, u)
          );
        },
        CallExpression: function (n, u, o) {
          var l, d, w;
          for (
            l = [this.generateExpression(n.callee, r.Call, we)],
              n.optional && l.push('?.'),
              l.push('('),
              d = 0,
        ...
        MemberExpression: function (n, u, o) {
          var l, d;
          return (
            (l = [this.generateExpression(n.object, r.Call, o & H ? we : je)]),
            n.computed
              ? (n.optional && l.push('?.'),
                l.push('['),
                l.push(this.generateExpression(n.property, r.Sequence, o & H ? M : rt)),
                l.push(']'))
              : (!n.optional &&
        ...
        MetaProperty: function (n, u, o) {
          ...
          return (
            (l = []),
            l.push(typeof n.meta == 'string' ? n.meta : ye(n.meta)),
            l.push('.'),
            l.push(typeof n.property == 'string' ? n.property : ye(n.property)),
            le(l, r.Member, u)
          );
        },
        ...
        FunctionExpression: function (n, u, o) {
          var l = [it(n, !0), 'function'];
          return (
            n.id ? (l.push(St(n) || fe()), l.push(ye(n.id))) : l.push(St(n) || v),
        ...
        ClassExpression: function (n, u, o) {
          ...
          return (
            ...
            n.superClass &&
              ...
              (l = U(l, d))),
            l.push(v),
            l.push(this.generateStatement(n.body, ge)),
            l
          );
        },
            ...
            ae(function (J) {
              ...
              for (ce = 0, Ue = n.properties.length; ce < Ue; ++ce)
                l.push(T ? J : ''),
                  ...
                  ce + 1 < Ue && l.push(',' + (T ? C : v));
            }),
            T && !he(Z(l).toString()) && l.push(C),
            l.push(T ? f : ''),
            l.push('}'),
            l
          );
        ...
        ImportDefaultSpecifier: function (n, u, o) {
          return ye(n.id || n.local);
        },
        ImportNamespaceSpecifier: function (n, u, o) {
          var l = ['*'],
            d = n.id || n.local;
          return d && l.push(v + 'as' + fe() + ye(d)), l;
        },
        ImportSpecifier: function (n, u, o) {
          var l = n.imported,
            d = [l.name],
            w = n.local;
          return w && w.name !== l.name && d.push(fe() + 'as' + fe() + ye(w)), d;
        },
        ...
        ComprehensionBlock: function (n, u, o) {
          ...
          return (
            n.left.type === t.VariableDeclaration
              ? (l = [n.left.kind, fe(), this.generateStatement(n.left.declarations[0], xt)])
        ...
        TaggedTemplateExpression: function (n, u, o) {
          ...
          var d = [
            ...
            this.generateExpression(n.quasi, r.Primary, tt),
          ];
      ...
      (oe.prototype.generateExpression = function (n, u, o) {
        ...
        return (
          ...
          A.verbatim && n.hasOwnProperty(A.verbatim)
            ? zn(n, u)
            : ((l = this[d](n, u, o)), A.comment && (l = Br(n, l)), Z(l, n))
        );
      }),
        ...
        return (
          ...
          n.type === t.Program &&
            ...
            l.charAt(l.length - 1) ===
              `
` &&
            (o = x ? Z(o).replaceRight(/\s+$/, '') : l.replace(/\s+$/, '')),
          Z(o, n)
        );
      });
    function $n(n) {
      var u;
      if (((u = new oe()), q(n))) return u.generateStatement(n, K);
      ...
      return (
        u != null
          ? (typeof u.indent == 'string' && (o.format.indent.style = u.indent),
            ...
            typeof u.base == 'string' ? (f = u.base) : (f = qe(p, u.format.indent.base)))
          : ((u = o), (p = u.format.indent.style), (f = qe(p, u.format.indent.base))),
        (y = u.format.json),
        (g = u.format.renumber),
        ...
        (A = u),
        x && (e.browser ? (s = lt.sourceMap.SourceNode) : (s = Es().SourceNode)),
        (l = $n(n)),
        x
...
function We(e, t) {
  return e < 48
    ...
    ? !0
    : e <= 65535
    ? e >= 170 && Gs.test(String.fromCharCode(e))
    : t === !1
    ? !1
    : ur(e, Oi) || ur(e, Ws);
}
...
var _e = { beforeExpr: !0 },
  ...
  Nt = {};
function X(e, t) {
  return t === void 0 && (t = {}), (t.keyword = e), (Nt[e] = new Y(e, t));
}
var h = {
    num: new Y('num', ve),
    regexp: new Y('regexp', ve),
    string: new Y('string', ve),
    name: new Y('name', ve),
    eof: new Y('eof'),
    ...
    _default: X('default', _e),
    _do: X('do', { isLoop: !0, beforeExpr: !0 }),
    _else: X('else', _e),
    _finally: X('finally'),
    _for: X('for', { isLoop: !0 }),
    _function: X('function', ve),
    _if: X('if'),
    _return: X('return', _e),
    _switch: X('switch'),
    _throw: X('throw', _e),
...
function Js(e) {
  var t = {};
  for (var r in wt) t[r] = e && Lt(e, r) ? e[r] : wt[r];
  if (
  ...
  return si(t.onComment) && (t.onComment = Xs(t, t.onComment)), t;
}
function Xs(e, t) {
...
var ai = 0,
  ...
  re = function (t, r, i) {
    (this.options = t = Js(t)),
      ...
      (this.keywords = Ge(js[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]));
    var s = '';
    if (t.allowReserved !== !0) {
      for (var a = t.ecmaVersion; !(s = sr[a]); a--);
      t.sourceType === 'module' && (s += ' await');
    }
    this.reservedWords = Ge(s);
    var c = (s ? s + ' ' : '') + sr.strict;
    (this.reservedWordsStrict = Ge(c)),
      (this.reservedWordsStrictBind = Ge(c + ' ' + sr.strictBind)),
      (this.input = String(r)),
      (this.containsEsc = !1),
      i
        ? ((this.pos = i),
...
ze.allowDirectSuper.get = function () {
  return (this.currentThisScope().flags & ji) > 0;
};
...
me.strictDirective = function (e) {
  for (;;) {
    (Ce.lastIndex = e), (e += Ce.exec(this.input)[0].length);
    var t = Hs.exec(this.input.slice(e));
    if (!t) return !1;
    if ((t[1] || t[2]) === 'use strict') {
      Ce.lastIndex = e + t[0].length;
      var r = Ce.exec(this.input),
...
W.isLet = function (e) {
  ...
  Ce.lastIndex = this.pos;
  var t = Ce.exec(this.input),
  ...
  if (i === 123) return !0;
  if (Re(i, !0)) {
    for (var s = r + 1; We(this.input.charCodeAt(s), !0); ) ++s;
    var a = this.input.slice(r, s);
    if (!qs.test(a)) return !0;
  }
  return !1;
};
W.isAsyncFunction = function () {
  ...
  Ce.lastIndex = this.pos;
  var e = Ce.exec(this.input),
    t = this.pos + e[0].length;
  return (
    !xe.test(this.input.slice(this.pos, t)) &&
...
W.parseTryStatement = function (e) {
  if ((this.next(), (e.block = this.parseBlock()), (e.handler = null), this.type === h._catch)) {
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Di : 0), this.checkLVal(t.param, r ? Ui : Oe), this.expect(h.parenR);
...
W.parseVarId = function (e, t) {
  (e.id = this.parseBindingAtom()), this.checkLVal(e.id, t === 'var' ? Sr : Oe, !1);
};
var ot = 1,
  lr = 2,
  Wi = 4;
  ...
  this.initFunction(e),
    ...
    t & ot &&
      ...
      e.id &&
        ...
        this.checkLVal(
          e.id,
          this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? Sr : Oe) : qi,
        ));
  var s = this.yieldPos,
    a = this.awaitPos,
...
W.parseClassId = function (e, t) {
  this.type === h.name
    ? ((e.id = this.parseIdent()), t && this.checkLVal(e.id, Oe, !1))
...
W.parseExport = function (e, t) {
  ...
  if (this.eat(h._default)) {
    ...
    if (this.type === h._function || (r = this.isAsyncFunction())) {
      var i = this.startNode();
      this.next(), r && this.next(), (e.declaration = this.parseFunction(i, ot | Wi, !1, r));
...
W.checkExport = function (e, t, r) {
  e && (Lt(e, t) && this.raiseRecoverable(r, "Duplicate export '" + t + "'"), (e[t] = !0));
};
...
W.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = Ys), (e.source = this.parseExprAtom()))
...
var Fe = re.prototype;
Fe.toAssignable = function (e, t, r) {
...
Fe.parseBindingList = function (e, t, r) {
...
Fe.parseMaybeDefault = function (e, t, r) {
...
Fe.checkLVal = function (e, t, r) {
  switch ((t === void 0 && (t = ai), e.type)) {
    case 'Identifier':
      t === Oe &&
        e.name === 'let' &&
        ...
        r &&
          (Lt(r, e.name) && this.raiseRecoverable(e.start, 'Argument name clash'),
          (r[e.name] = !0)),
        t !== ai && t !== Gi && this.declareName(e.name, t, e.start);
      break;
    case 'ChainExpression':
      this.raiseRecoverable(e.start, 'Optional chaining cannot appear in left-hand side');
      break;
...
z.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(br(t, i.generator) | Vi | (r ? ji : 0)),
    this.expect(h.parenL),
...
z.parseFunctionBody = function (e, t, r) {
  ...
  if (i) (e.body = this.parseMaybeAssign()), (e.expression = !0), this.checkParams(e, !1);
    ...
    (this.labels = []),
      ...
      this.strict && e.id && this.checkLVal(e.id, Gi),
...
kt.raiseRecoverable = kt.raise;
kt.curPosition = function () {
  if (this.options.locations) return new Qe(this.curLine, this.pos - this.lineStart);
};
var Ve = re.prototype,
  Zs = function (t) {
...
Ve.declareName = function (e, t, r) {
  ...
  if (t === Oe) {
    ...
    for (var f = this.scopeStack.length - 1; f >= 0; --f) {
      ...
      if (
        (p.lexical.indexOf(e) > -1 && !(p.flags & Di && p.lexical[0] === e)) ||
...
Ve.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & xr && !(t.flags & Bi)) return t;
  }
};
...
Ft.finishNodeAt = function (e, t, r, i) {
  return zi.call(this, e, t, r, i);
};
...
h._function.updateContext = h._class.updateContext = function (e) {
  ...
  e !== h.semi &&
  e !== h._else &&
  !(e === h._return && xe.test(this.input.slice(this.lastTokEnd, this.start))) &&
...
var $i =
  ...
  ra = Hi + ' Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho',
  ia = { 9: Xi, 10: Hi, 11: ra },
  Qi = {};
function Er(e) {
  var t = (Qi[e] = {
    binary: Ge(ta[e] + ' ' + oi),
    nonBinary: { General_Category: Ge(oi), Script: Ge(ia[e]) },
  });
...
var j = re.prototype,
  Me = function (t) {
    (this.parser = t),
      ...
      (this.unicodeProperties = Qi[t.options.ecmaVersion >= 11 ? 11 : t.options.ecmaVersion]),
      (this.source = ''),
      (this.flags = ''),
      (this.start = 0),
      (this.switchU = !1),
...
Me.prototype.reset = function (t, r, i) {
  var s = i.indexOf('u') !== -1;
  (this.start = t | 0),
    (this.source = r + ''),
    (this.flags = i),
...
Me.prototype.nextIndex = function (t, r) {
  r === void 0 && (r = !1);
  var i = this.source,
    s = i.length;
  if (t >= s) return s;
...
j.regexp_eatPatternCharacters = function (e) {
  for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Yi(r); ) e.advance();
  return e.pos !== t;
};
...
j.regexp_eatRegExpIdentifierName = function (e) {
  if (((e.lastStringValue = ''), this.regexp_eatRegExpIdentifierStart(e))) {
    for (e.lastStringValue += Tt(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e); )
      e.lastStringValue += Tt(e.lastIntValue);
    return !0;
  }
  return !1;
};
j.regexp_eatRegExpIdentifierStart = function (e) {
  ...
  return (
    ...
    na(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function na(e) {
...
j.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    e.advance(r),
    i === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, r) && (i = e.lastIntValue),
    sa(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function sa(e) {
...
j.regexp_eatZero = function (e) {
  return e.current() === 48 && !Bt(e.lookahead()) ? ((e.lastIntValue = 0), e.advance(), !0) : !1;
};
...
j.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
  ...
  if (e.eat(117)) {
    ...
    if (i && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && aa(e.lastIntValue))
      return !0;
...
j.regexp_eatCharacterClassEscape = function (e) {
  var t = e.current();
  if (oa(t)) return (e.lastIntValue = -1), e.advance(), !0;
...
j.regexp_validateUnicodePropertyNameAndValue = function (e, t, r) {
  Lt(e.unicodeProperties.nonBinary, t) || e.raise('Invalid property name'),
...
j.regexp_eatUnicodePropertyName = function (e) {
  var t = 0;
  for (e.lastStringValue = ''; Zi((t = e.current())); ) (e.lastStringValue += Tt(t)), e.advance();
...
j.regexp_eatUnicodePropertyValue = function (e) {
  var t = 0;
  for (e.lastStringValue = ''; ua((t = e.current())); ) (e.lastStringValue += Tt(t)), e.advance();
  return e.lastStringValue !== '';
};
function ua(e) {
  return Zi(e) || Bt(e);
...
j.regexp_eatClassAtom = function (e) {
  ...
  if (e.eat(92)) {
    ...
    if (e.switchU) {
      var r = e.current();
      (r === 99 || rn(r)) && e.raise('Invalid class escape'), e.raise('Invalid escape');
    }
    e.pos = t;
  }
  var i = e.current();
...
j.regexp_eatClassControlLetter = function (e) {
  var t = e.current();
  return Bt(t) || t === 95 ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
};
...
j.regexp_eatDecimalDigits = function (e) {
  var t = e.pos,
    r = 0;
  for (e.lastIntValue = 0; Bt((r = e.current())); )
...
j.regexp_eatHexDigits = function (e) {
  var t = e.pos,
    r = 0;
  for (e.lastIntValue = 0; en((r = e.current())); )
    (e.lastIntValue = 16 * e.lastIntValue + tn(r)), e.advance();
  return e.pos !== t;
};
function en(e) {
...
j.regexp_eatOctalDigit = function (e) {
  var t = e.current();
  return rn(t) ? ((e.lastIntValue = t - 48), e.advance(), !0) : ((e.lastIntValue = 0), !1);
};
function rn(e) {
  return e >= 48 && e <= 55;
}
j.regexp_eatFixedHexDigits = function (e, t) {
  ...
  for (var i = 0; i < t; ++i) {
    var s = e.current();
    if (!en(s)) return (e.pos = r), !1;
    (e.lastIntValue = 16 * e.lastIntValue + tn(s)), e.advance();
  }
  return !0;
};
var Dt = function (t) {
...
$.next = function (e) {
  !e &&
    ...
    this.options.onToken && this.options.onToken(new Dt(this)),
...
$.readToken = function (e) {
  return Re(e, this.options.ecmaVersion >= 6) || e === 92
    ? this.readWord()
...
$.skipBlockComment = function () {
  ...
  if (
    ...
    He.lastIndex = t;
    for (var i; (i = He.exec(this.input)) && i.index < this.pos; )
...
$.readToken_plus_min = function (e) {
  ...
  return t === e
    ? t === 45 &&
      ...
      (this.lastTokEnd === 0 || xe.test(this.input.slice(this.lastTokEnd, this.pos)))
...
$.readRegexp = function () {
  for (var e, t, r = this.pos; ; ) {
    ...
    if ((xe.test(i) && this.raise(r, 'Unterminated regular expression'), e)) e = !1;
    else {
      if (i === '[') t = !0;
      else if (i === ']' && t) t = !1;
      else if (i === '/' && !t) break;
  ...
  var f = this.regexpState || (this.regexpState = new Me(this));
...
$.readRadixNumber = function (e) {
  ...
  return (
    ...
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((r = nn(this.input.slice(t, this.pos))), ++this.pos)
      : Re(this.fullCharCodeAtPos()) && this.raise(this.pos, 'Identifier directly after number'),
...
$.readNumber = function (e) {
  ...
  if (!r && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var s = nn(this.input.slice(t, this.pos));
    return (
      ++this.pos,
      Re(this.fullCharCodeAtPos()) && this.raise(this.pos, 'Identifier directly after number'),
  ...
  r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    Re(this.fullCharCodeAtPos()) && this.raise(this.pos, 'Identifier directly after number');
  var a = la(this.input.slice(t, this.pos), r);
...
$.readWord1 = function () {
  ...
  for (
    ...
    if (We(s, i)) this.pos += s <= 65535 ? 1 : 2;
    else if (s === 92) {
      ...
      (t ? Re : We)(c, i) || this.invalidStringToken(a, 'Invalid Unicode escape'),
        (e += Cr(c)),
        (r = this.pos);
    } else break;
    t = !1;
...
$.readWord = function () {
  var e = this.readWord1(),
    t = h.name;
  return this.keywords.test(e) && (t = Nt[e]), this.finishToken(t, e);
};
var an = '7.4.1';
re.acorn = {
  Parser: re,
...
var va = _i,
  ...
  Ea = Object.prototype,
  ln = _a.toString,
  Ca = Ea.hasOwnProperty,
  Aa = ln.call(Object);
function wa(e) {
  if (!ba(e) || va(e) != Sa) return !1;
  var t = xa(e);
  if (t === null) return !0;
  var r = Ca.call(t, 'constructor') && t.constructor;
  return typeof r == 'function' && r instanceof r && ln.call(r) == Aa;
}
var ka = wa;
const Ta = pt(ka);
var Pa = _i,
  ...
  La = '[object String]';
function Oa(e) {
  return typeof e == 'string' || (!Ia(e) && Na(e) && Pa(e) == La);
}
var Ra = Oa;
const Fa = pt(Ra);
/*!
...
`,
  ...
  if (at.indexOf(e) !== -1) return '"[Circular]"';
  if (
    e == null ||
    typeof e == 'number' ||
    typeof e == 'boolean' ||
 ...
 */ var wr = Symbol.for('react.element'),
  ...
  Ua = Symbol.for('react.server_context'),
...
ee.ContextConsumer = Gt;
ee.ContextProvider = Ut;
ee.Element = wr;
ee.ForwardRef = Wt;
ee.Fragment = Vt;
ee.Lazy = Xt;
...
var pn = function (t) {
  ...
  Za = function e(t) {
    switch (!0) {
      ...
      case t.$$typeof === Te.Memo:
        return e(t.type);
      case t.$$typeof === Te.ForwardRef:
        return e(t.render);
      default:
        return dn(t);
    }
  ...
  eo = function (t) {
    switch (!0) {
      ...
      case typeof t.type == 'function':
        return t.type.displayName ? t.type.displayName : dn(t.type);
      case Te.isForwardRef(t):
      case Te.isMemo(t):
        return Za(t.type);
      case Te.isContextConsumer(t):
        return ''.concat(t.type._context.displayName || 'Context', '.Consumer');
      case Te.isContextProvider(t):
        return ''.concat(t.type._context.displayName || 'Context', '.Provider');
      case Te.isLazy(t):
        return 'Lazy';
      case Te.isProfiler(t):
        return 'Profiler';
      case Te.isStrictMode(t):
        return 'StrictMode';
      case Te.isSuspense(t):
        return 'Suspense';
      default:
  ...
  Tr = function e(t, r) {
    ...
    if (typeof t == 'number') return Ha(t);
    ...
    var p = fi(t.type.defaultProps || {}, hi),
      y = Le.Children.toArray(t.props.children)
        .filter(to)
        .map(function (g) {
          return e(g, r);
        });
    return Ka && t.type === Pe.Fragment ? Ya(f, y) : Qa(a, c, p, y);
  };
function ro() {}
var io = function (t) {
    return t
  ...
  no = function (e, t, r, i) {
    ...
    return t
      ? a
          ...
          .replace(/\[ /g, '[')
          .replace(/ ]/g, ']')
      : a.replace(/\t/g, Ne(1, i.tabStop)).replace(
          /\n([^$])/g,
          `
`.concat(Ne(r + 1, i.tabStop), '$1'),
        );
  },
  so = function (t) {
    return t.replace(/"/g, '&quot;');
  ...
  ao = function (t, r, i, s) {
    ...
    if (typeof t == 'string') return '"'.concat(so(t), '"');
    if (ht(t) === 'symbol') {
      var a = t
        .valueOf()
        .toString()
    ...
    return typeof t == 'function'
      ? '{'.concat(mn(t, s), '}')
      : Pe.isValidElement(t)
      ? '{'.concat(Ht(Tr(t, s), !0, i, s), '}')
      : t instanceof Date
      ? isNaN(t.valueOf())
        ? '{new Date(NaN)}'
        : '{new Date("'.concat(t.toISOString(), '")}')
      : Ma(t) || Array.isArray(t)
      ? '{'.concat(no(t, r, i, s), '}')
      : '{'.concat(String(t), '}');
  },
  oo = function (e, t, r, i, s, a, c, f) {
    if (!t && !i)
      throw new Error(
  ...
  uo = function (e, t) {
    ...
    return (
      ...
      (i.type === 'string' || i.type === 'number')
        ? r.push(pn(String(i.value) + String(t.value)))
        : (i && r.push(i), r.push(t)),
      r
    );
  },
...
`,
          ...
          .map(function (f, p) {
            return p === 0 ? f : ''.concat(Ne(s, c)).concat(f);
          }).join(`
`)
      : r;
  },
  ...
  gn = function (t, r, i, s, a) {
    return a ? Ne(i, s).length + r.length > a : t.length > 1;
  },
  go = function (t, r, i, s, a, c, f) {
    return (gn(t, r, a, c, f) || i) && !s;
  },
  yn = function (e, t, r, i) {
    var s = e.type,
      a = e.displayName,
    ...
    if (
      (_.forEach(function (B) {
        var R = oo(B, Object.keys(y).includes(B), y[B], Object.keys(b).includes(B), b[B], t, r, i),
...
`),
  ...
  So = function (e, t, r, i) {
    ...
    var f = i.useFragmentShortSyntax,
      p;
    return f ? (bo(e) || xo(e) ? (p = di) : (p = yo)) : (p = di), yn(vo(p, a, c), t, r, i);
  },
  _o = ['<', '>', '{', '}'],
  Eo = function (t) {
    return _o.some(function (r) {
      return t.includes(r);
    });
  },
  Co = function (t) {
  ...
  Ht = function (e, t, r, i) {
    ...
    if (e.type === 'string') return e.value ? ''.concat(Ao(Co(String(e.value)))) : '';
    if (e.type === 'ReactElement') return yn(e, t, r, i);
    if (e.type === 'ReactFragment') return So(e, t, r, i);
...
const { defaultDecorateStory: ko, addons: To, useEffect: Po } = __STORYBOOK_MODULE_PREVIEW_API__,
...
var fr = 'custom',
  ...
  et = 'element';
function Ir(e) {
  return gs.includes(e.toLowerCase());
}
var vn = { format: { indent: { style: '  ' }, semicolons: !1 } },
  Ro = { ...vn, format: { newline: '' } },
  Fo = { ...vn };
function Be(e, t = !1) {
  return ki.generate(e, t ? Ro : Fo);
}
function pr(e, t = !1) {
  return t ? Mo(e) : Be(e);
}
...
function Bo(e) {
  let t = Be(e);
  return t.endsWith('  }]') && (t = as(t)), t;
}
function Do(e) {
  let t = Be(e, !0);
  return t.startsWith('[    ') && (t = t.replace('[    ', '[')), t;
}
var xn = e => e.$$typeof === Symbol.for('react.memo'),
  Vo = e => e.$$typeof === Symbol.for('react.forward_ref'),
  Nr = { ...N, JSXElement: () => {} },
  jo = re.extend(ga());
function vt(e) {
...
function $o(e) {
  ...
  return vt(t) === 'shape' ? Sn(e.arguments[0]) : null;
}
function Sn(e) {
  return { inferredType: { type: 'Object', depth: bn(e) }, ast: e };
}
function Jo(e) {
  return { inferredType: { type: 'Array', depth: bn(e) }, ast: e };
}
function Xo(e) {
  switch (e.type) {
    case 'Identifier':
...
function En(e, t) {
  ...
  switch (s) {
    ...
    case 'Object': {
      let { depth: p } = r;
      (a = yt), (c = p === 1 ? It(i, !0) : null), (f = It(i));
      break;
    }
    case 'Element': {
      let { identifier: p } = r;
      (a = p != null && !Ir(p) ? p : et), (c = yi(e).length === 1 ? e : null), (f = e);
      break;
    }
    case 'Array': {
      let { depth: p } = r;
      (a = Pr), (c = p <= 2 ? vi(i, !0) : null), (f = vi(i));
      break;
    }
    default:
      (a = Yo(s)), (c = yi(e).length === 1 ? e : null), (f = e);
      break;
  }
  return de({ name: t, short: a, compact: c, full: f, inferredType: s });
}
function Ko({ raw: e }) {
  return e != null ? En(e, 'custom') : de({ name: 'custom', short: fr, compact: fr });
}
function Zo(e) {
  let { jsDocTags: t } = e;
  return t != null && (t.params != null || t.returns != null)
    ? de({
        name: 'func',
        short: No(t.params, t.returns),
        compact: null,
        full: Io(t.params, t.returns),
      })
    : de({ name: 'func', short: Ye, compact: Ye });
}
function eu(e, t) {
  let r = Object.keys(e.value)
      .map(c => `${c}: ${Ke(e.value[c], t).full}`)
      .join(', '),
    { inferredType: i, ast: s } = De(`{ ${r} }`),
    { depth: a } = i;
  return de({
    name: 'shape',
    short: yt,
    compact: a === 1 && s ? It(s, !0) : null,
    full: s ? It(s) : null,
  });
}
function or(e) {
...
function tu(e, t) {
  let { short: r, compact: i, full: s } = Ke(e.value, t);
  return de({
    name: 'objectOf',
    short: or(r),
...
function ru(e, t) {
  if (Array.isArray(e.value)) {
    let r = e.value.reduce(
      (i, s) => {
        let { short: a, compact: c, full: f } = Ke(s, t);
...
function iu({ value: e, computed: t }) {
  return t ? En(e, 'enumvalue') : de({ name: 'enumvalue', short: e, compact: e });
}
function nu(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, i) => {
        let { short: s, compact: a, full: c } = iu(i);
...
function bi(e, t, r) {
  return de({ name: 'arrayOf', short: dr(e), compact: t != null ? xi(t) : null, full: r && xi(r) });
}
function su(e, t) {
  let { name: r, short: i, compact: s, full: a, inferredType: c } = Ke(e.value, t);
  if (r === 'custom') {
    if (c === 'Object') return bi(i, s, a);
  } else if (r === 'shape') return bi(i, s, a);
...
function au(e) {
  ...
  try {
    switch (t.name) {
      ...
      case 'enum':
      case 'arrayOf': {
        let { short: r, compact: i, full: s } = Ke(t, e);
        return i != null && !ns(i) ? te(i) : s ? te(r, s) : te(r);
      }
      case 'func': {
        let { short: r, full: i } = Ke(t, e),
          s = r,
          a;
        return i && i.length < Qo ? (s = i) : i && (a = Lo(i)), te(s, a);
      }
      default:
        return null;
    }
...
function Cn({ inferredType: e, ast: t }) {
  let { depth: r } = e;
  if (r === 1) {
    let i = pr(t, !0);
    if (!ft(i)) return te(i);
...
function An({ inferredType: e, ast: t }) {
  let { depth: r } = e;
  if (r <= 2) {
    let i = mi(t, !0);
    if (!ft(i)) return te(i);
...
function ou({ inferredType: e, ast: t }) {
  let { identifier: r } = e;
  if (r != null) return te(wn(e), Be(t));
  let i = Be(t, !0);
  return ft(i) ? te(Ye, Be(t)) : te(i);
}
function uu(e, t) {
...
var hu = e => {
    if (Tn(e) && e.type != null) return cu(e);
    if (Ta(e)) {
      let t = De(JSON.stringify(e));
      return Cn(t);
    }
    if (Array.isArray(e)) {
      let t = De(JSON.stringify(e));
  ...
  pu = e => te(e.toString()),
  In = { string: lu, object: hu, function: fu, default: pu };
function du(e = {}) {
  return { ...In, ...e };
}
function Nn(e, t, r = In) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t);
...
var gu = (e, { name: t, type: r }) => {
    let i = r.summary === 'element' || r.summary === 'elementType',
      s = Pn(e, t);
    if (s != null) {
      if (i) return te(Qt(s));
      let { hasParams: a } = De(e.toString()).inferredType;
      return te(Lr(s, a));
    }
    return te(i ? et : Ye);
  },
...
function xu(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    i = e.map(s => vu(s, r[s.propDef.name]));
  return mu(i, t);
}
function bu(e, t) {
  let { propDef: r } = e,
...
Object.keys(Jr).forEach(e => {
  let t = Jr[e];
  Si.set(t, e), Si.set(t.isRequired, e);
});
function _u(e, t) {
  let r = e;
  !rs(e) && !e.propTypes && xn(e) && (r = e.type);
  let i = is(r, t);
...
var Au = (e, t) => {
    if (typeof e > 'u') return Ct.warn('Too many skip or undefined component'), null;
    let r = e,
      i = r.type;
    for (let a = 0; a < t.skip; a += 1) {
      if (typeof r > 'u') return Ct.warn('Cannot skip undefined element'), null;
      if (Le.Children.count(r) > 1) return Ct.warn('Trying to skip an array of elements'), null;
      typeof r.props.children > 'u'
        ? (Ct.warn('Not enough children to skip elements.'),
          typeof r.type == 'function' &&
            r.type.name === '' &&
            (r = Le.createElement(i, { ...r.props })))
      ...
      ...(typeof t.displayName == 'string'
        ...
        : {
            displayName: a =>
              ...
              ts(a.type, 'displayName') ||
              (a.type.name !== '_default' ? a.type.name : null) ||
              (typeof a.type == 'function' ? 'No Display Name' : null) ||
              (Vo(a.type) ? a.type.render.name : null) ||
              (xn(a.type) ? a.type.type.name : null) ||
              a.type,
          }),
      filterProps: (a, c) => a !== void 0,
      ...t,
    };
    return Le.Children.map(e, a => {
...
`,
  ...
  wu = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  ku = e => {
    var i;
    let t = (i = e == null ? void 0 : e.parameters.docs) == null ? void 0 : i.source,
      r = e == null ? void 0 : e.parameters.__isArgsStory;
    return (t == null ? void 0 : t.type) === Gr.DYNAMIC
      ? !1
      : !r || (t == null ? void 0 : t.code) || (t == null ? void 0 : t.type) === Gr.CODE;
  },
  Tu = e => {
    var t, r;
    return (
  ...
  Ln = e => {
    ...
    let { mdxType: t, originalType: r, children: i, ...s } = e.props,
      a = [];
    return i && (a = (Array.isArray(i) ? i : [i]).map(Ln)), Pe.createElement(r, s, ...a);
  },
  On = (e, t) => {
    var g, b;
    let r = To.getChannel(),
    ...
    Po(() => {
      if (!i) {
        ...
        r.emit(Zn, { id: E, source: s, args: S });
      }
    });
    let a = e();
    if (i) return a;
    let c = { ...wu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      f =
  ...
  Pu = { docs: { story: { inline: !0 }, extractArgTypes: Cu, extractComponentDescription: es } },
  Vu = [On],
  ju = [Kn],
  qu = (e, t) => {
    let r = t.findIndex(s => s.originalFn === On),
      i = r === -1 ? t : [...t.splice(r, 1), ...t];
    return ko(e, i);
  },
  Uu = { renderer: 'react', ...Pu };
export {
  qu as applyDecorators,
  ju as argTypesEnhancers,
  Vu as decorators,
  Uu as parameters,
  Bu as render,
  Du as renderToCanvas,
};
//# sourceMappingURL=config-0477d0c2.js.map
