...
var p = 'backgrounds',
  ...
  L = (r, e, n) => {
    ...
    if (t) t.innerHTML !== e && (t.innerHTML = e);
      ...
      let i = `addon-backgrounds-grid${n ? `-docs-${n}` : ''}`,
        d = s.getElementById(i);
      d ? d.parentElement.insertBefore(a, d) : s.head.appendChild(a);
    }
  };
const { useMemo: b, useEffect: k } = __STORYBOOK_MODULE_PREVIEW_API__;
var O = (r, e) => {
    var c;
    let { globals: n, parameters: t } = e,
      a = (c = n[p]) == null ? void 0 : c.value,
      i = t[p],
      d = b(() => (i.disable ? 'transparent' : _(a, i.values, i.default)), [i, a]),
      o = b(() => d && d !== 'transparent', [d]),
      g = e.viewMode === 'docs' ? `#anchor--${e.id} .docs-story` : '.sb-show-main',
      u = b(() => {
    ...
    return (
      k(() => {
        ...
        L(l, u, e.viewMode === 'docs' ? e.id : null);
      }, [o, u, e]),
      r()
    );
  },
  T = (r, e) => {
    ...
    let { globals: n, parameters: t } = e,
      a = t[p].grid,
      i = ((y = n[p]) == null ? void 0 : y.grid) === !0 && a.disable !== !0,
      { cellAmount: d, cellSize: o, opacity: g } = a,
      u = e.viewMode === 'docs',
