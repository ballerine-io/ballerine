...
export const WorkflowDefinitionVariant = {
  ...
  KYC_VENDOR_MANUAL_REVIEW: 'KYC_VENDOR_MANUAL_REVIEW',
  KYB_MANUAL_REVIEW_LEGACY: 'KYB_MANUAL_REVIEW_LEGACY',
  KYB_MANUAL_REVIEW: 'KYB_MANUAL_REVIEW',
  KYB_COLLECTION_FLOW: 'KYB_WITH_COLLECTION_FLOW',
  KYB_COLLECTION_FLOW_WITH_VENDORS: 'KYB_WITH_COLLECTION_FLOW_WITH_VENDORS',
  DEMO_KYB_WITH_COLLECTION_FLOW: 'DEMO_KYB_WITH_COLLECTION_FLOW',
