...
import { TRANSACTIONS_ALERT_DEFINITIONS } from '../../scripts/alerts/generate-alerts';
    ...
    describe.only('', () => {
      ...
      describe('should correctly evaluate sum of incoming transactions over a set period of time is greater than a limit of', () => {
        it('credit card.', async () => {
          // Assert
          const rule = TRANSACTIONS_ALERT_DEFINITIONS.PAY_HCA_CC;
        ...
        it('non credit card.', async () => {
          // Assert
          const rule = TRANSACTIONS_ALERT_DEFINITIONS.PAY_HCA_APM;
          expect(rule).toBeDefined();
