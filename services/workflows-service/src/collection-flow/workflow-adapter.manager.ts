...
import { KycOnboardingSierraLeoneAdapter } from '@/collection-flow/workflow-adapters/kyc_onboarding_sierra_leone/kyc_onboarding_sierra_leone.workflow-adapter';
...
export class WorkflowAdapterManager {
  private readonly adapters: Record<string, IWorkflowAdapter> = {
    ...
    kyc_onboarding_sierra_leone: new KycOnboardingSierraLeoneAdapter(),
  };
