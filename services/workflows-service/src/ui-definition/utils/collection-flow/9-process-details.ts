                    ...
                    processingDetails: {
                      ...
                      properties: {
                        monthlySalesVolume: {
                          ...
                          errorMessage: {minimum: 'Monthly Sales Volume must be greater than 0.'}
                        },
                        monthlyTransactions: {
                          type: 'number', minimum: 1,
                          errorMessage: {minimum: 'Monthly Transactions must be greater than 0.'},
                        },
                        averageTicketAmount: {
                          type: 'number', minimum: 1,
                          errorMessage: {minimum: 'Average Ticket Amount must be greater than 0.'},
                        },
                        businessModel: {
                          type: 'string', minLength: 2,
                          errorMessage: {minimum: 'Business Model must be more than 2 characters.'},
                        },
