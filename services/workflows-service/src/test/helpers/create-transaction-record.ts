...
export const createTransactionRecord = async (
  ...
  const transactionCreateDto: Omit<TransactionCreateDto, 'projectId'> = {
    ...
    baseAmount: faker.number.int({ min: 1, max: 1000 }),
    ...
    originator: {
      ...
      bankCountry: faker.location.countryCode(),
      businessData: {
    ...
    cardDetails: {
      ...
      issuedCountry: faker.location.countryCode(),
      ...
      tokenized: faker.string.alphanumeric(24),
