  ...
  elements: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          params: {
            label: kc('text.companyActivity.annualVolumeAmountInput.label'),
            placeholder: kc('text.companyActivity.annualVolumeAmountInput.hint'),
            valueType: 'number',
          },
          validate: [
            {
        ...
        },
        {
          ...
          params: {
            label: kc('text.companyActivity.averageTransactionValueInput.label'),
            placeholder: kc('text.companyActivity.averageTransactionValueInput.hint'),
            valueType: 'number',
          },
          validate: [
            {
