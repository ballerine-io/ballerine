          ...
          transform: [
            {
              ...
              resubmissionLink: join('',[entity.data.additionalInfo.normalizedCustomerCompany,'.demo.ballerine.app','/workflowRuntimeId=',workflowRuntimeId,'?resubmitEvent=RESUBMITTED']),
              supportEmail: join('',[entity.data.additionalInfo.normalizedCustomerCompany,'@support.com']),
