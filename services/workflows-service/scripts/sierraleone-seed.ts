  ...
  await upsertCaseMgmtUi(
    ...
    [
      ...
      },
      {
        ...
        categories: ['proof_of_registration', 'business_document', 'proof_of_address', 'proof_of_ownership'],
      },
      {
  ...
  await upsertCaseMgmtUi(
    ...
    [
      ...
      },
      {
        ...
        type: 'document-review',
        title: 'Business Documents',
        categories: ['proof_of_identity', 'proof_of_identity_ownership', 'business_document', 'proof_of_address', 'proof_of_location', 'financial_information'],
      },
      {
