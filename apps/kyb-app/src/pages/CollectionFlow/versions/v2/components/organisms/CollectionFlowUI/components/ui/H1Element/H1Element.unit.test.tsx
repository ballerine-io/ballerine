...
import { H1_UI_ELEMENT_TYPE, H1Element } from './H1Element';
import { TH1ElementParams } from '@ballerine/common';
...
describe('H1Element', () => {
  ...
  it('renders within ElementContainer', () => {
    ...
    } as IFormElement<typeof H1_UI_ELEMENT_TYPE, TH1ElementParams>;
