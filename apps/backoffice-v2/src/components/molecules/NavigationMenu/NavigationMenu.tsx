...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={ctw('relative z-10 flex flex-1 items-center justify-center', className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={ctw('group flex flex-1 list-none items-center justify-center', className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={ctw(navigationMenuTriggerStyle(), 'group', className)}
    {...props}
  >
    {children}{' '}
    <ChevronDown
...
>(({ className, ...props }, ref) => (
  <div className={ctw('absolute left-0 top-full flex justify-center')}>
