/**
 * @description Returns a string from a passed date in the format of the end user's browser locale if possible, otherwise falls back to fallbackLocale (defaults to en-US).
 *
 * @param date - An instance of Date to format with Intl.DateTimeFormat.
 * @param [fallbackLocale='en-US'] - A string representing a locale to use if the end user's browser locale is not supported.
 *
