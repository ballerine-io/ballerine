...
export const CaseTabs = [
  'summary',
  'kyb',
  // Backward compatibility for existing links. The KYC layout now uses explicit
  // kycProfile/kycDocuments/kycVerification/kycAml/kycCustomData tabs.
  'kyc',
  'kycProfile',
  'kycDocuments',
  'kycVerification',
