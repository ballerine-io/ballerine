...
import { useOngoingMonitoringAlertsTableLogic } from '@/pages/OngoingMonitoringAlerts/components/OngoingMonitoringAlertsTable/hooks/useOngoingMonitoringAlertsTableLogic/useOngoingMonitoringAlertsTableLogic';
import { IOngoingMonitoringAlertsTableProps } from '@/pages/OngoingMonitoringAlerts/components/OngoingMonitoringAlertsTable/interfaces';
...
export const OngoingMonitoringAlertsTable: FunctionComponent<
  IOngoingMonitoringAlertsTableProps
> = ({ data }) => {
  const { table, locale, onRowClick, search } = useOngoingMonitoringAlertsTableLogic({ data });
