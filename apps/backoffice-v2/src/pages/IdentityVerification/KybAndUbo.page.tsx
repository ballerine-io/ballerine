...
import { IdentityVerificationTable } from './components/IdentityVerificationTable/KybAndUboChecksTable';
    ...
    >
      <div className="space-y-4 px-6 pb-6">
        <div className={`flex justify-between pb-2`}>
          <h1 className="text-2xl font-bold">KYB & UBOs</h1>
        ...
        <div className="space-y-6">
          ...
          {!isLoadingBusinessReports && isNonEmptyArray(businessReports) && (
            <IdentityVerificationTable data={businessReports} isDemoAccount={isDemoAccount} />
          )}
          {!isLoadingBusinessReports &&
            Array.isArray(businessReports) &&
            !businessReports.length && <NoIdentityVerificationChecks />}
