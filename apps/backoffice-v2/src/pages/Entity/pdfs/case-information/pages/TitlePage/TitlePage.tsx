      ...
      <View style={tw('flex flex-col p-5')}>
        ...
        <View style={tw('flex flex-col bg-[#F6F6F6] rounded-[11px] p-3 gap-3 ')}>
          ...
          <Typography styles={[tw('text-[6px] text-[#5E5E5E] text-justify')]}>
            This report is provided “as is” by MiKashBoks for informational purposes. It is derived
            from data submitted by our customers and third parties. MiKashBoks does not guarantee
            the accuracy, completeness, or usefulness of any information in the report and is not
            responsible for any errors or omissions, or for results obtained from the use of this
            information.
          </Typography>
          <Typography styles={[tw('text-[6px] text-[#5E5E5E] text-justify')]}>
            By using this report, you agree that MiKashBoks shall not be liable for any direct,
          ...
          <Typography styles={[tw('text-[6px] text-[#5E5E5E] text-justify')]}>
            Use of this report is at your sole risk. MiKashBoks disclaims all liability for any loss
