 ...
 * @constructor
 */
export const PDFRevisionCaseActions: FunctionComponent<IActionsProps> = ({
  id,
  fullName,
  showResolutionButtons,
}) => {
  const { tag, assignedUser, authenticatedUser, isLoadingCase, assignees, onMutateAssignWorkflow } =
