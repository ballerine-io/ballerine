        ...
        <DialogContent className={`mb-96`}>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              directing them to re-upload the documents you have marked as “re-upload needed”. The
              case’s status will then change to “Revisions” until the customer will provide the
