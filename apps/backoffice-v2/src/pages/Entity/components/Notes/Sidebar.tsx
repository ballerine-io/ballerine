...
import { Button, ctw, Input, Skeleton } from '@ballerine/ui';
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={ctw(sidebarMenuButtonVariants({ variant, size }), className)}
        {...props}
      />
    );
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={ctw('flex h-8 items-center gap-2 rounded-md px-2', className)}
      {...props}
    >
