...
interface ReportPDFContainerProps {
  ...
  toggleIsGeneratingPDF: (next?: boolean) => void;
...
>(
  (
    ...
    }, [generatePDF, isGeneratingPDF, setIsDropdownOpen, toggleIsGeneratingPDF]);
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col gap-4 rounded-md bg-white p-5">
          ...
          <BusinessReport report={businessReport} disableSectionObserver={true} />
        </div>
        ...
        <div className="flex flex-col gap-4 opacity-50">
          ...
          <div className="flex flex-col text-[8px]">
            ...
            <div>
              ...
              suitability, or availability for any purpose. Whilst We endeavor to keep the
              information up to date and correct, Ballerine makes no representations or warranties
              regarding the completeness, accuracy, reliability, or availability of the Report or
              any related information and will not be liable for any false, inaccurate,
              inappropriate, or incomplete information presented. You are solely responsible for
              ensuring compliance with all applicable laws, including privacy regulations (e.g.,{' '}
              <span className="font-bold">GDPR, CCPA</span>), and may not disclose, distribute, or
              share this Report or its contents with any third party without Ballerine’s prior
              written consent. To the maximum extent permitted by law, Ballerine disclaims all
              liability for any direct, indirect, incidental, special, punitive, or consequential
              damages arising from the use of this Report, and You assume full responsibility for
              any misuse, regulatory breaches, or violations of the MSA.
            </div>
          </div>
        </div>
      </div>
