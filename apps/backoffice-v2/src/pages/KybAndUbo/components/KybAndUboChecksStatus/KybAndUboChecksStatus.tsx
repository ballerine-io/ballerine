...
import { useKybAndUbosStatusDialog } from './hooks/useKybAndUbosStatusDialog/useKybAndUbosStatusDialog';
import { KybAndUboChecksStatusBadge } from './KybAndUboChecksStatusBadge';
import { KybAndUboChecksStatusButton } from './KybAndUboChecksStatusButton';
...
export const KybAndUboChecksStatus = ({
  status,
  reportId,
  className,
  businessId,
  ...
  const { dialogState, toggleDialogOpenState, closeDialog } = useKybAndUbosStatusDialog();
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            {dialogState.status && (
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <KybAndUboChecksStatusBadge status={dialogState.status} />
                </div>
              </div>
            )}
            <FormField
