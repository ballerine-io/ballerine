  ...
  return (
    <Dialog open={open} onOpenChange={toggleOpen}>
      ...
      <DialogContent className="px-0 sm:max-w-xl">
        ...
        {showSuccess ? (
          <CreateCheckDialogSuccessContent subject="KYB & Ownership case" />
        ) : (
          <CreateKybAndOwnershipDialogContent
            form={form}
            onSubmit={onSubmit}
...
export type CreateKybAndOwnershipDialogContentProps = Pick<
  ReturnType<typeof useCreateKybAndOwnershipAssessmentDialogLogic>,
  'form' | 'onSubmit' | 'isSubmitting'
>;

export const CreateKybAndOwnershipDialogContent = ({
  form,
  onSubmit,
  isSubmitting,
}: CreateKybAndOwnershipDialogContentProps) => {
  return (
    <div>
      <Form {...form}>
