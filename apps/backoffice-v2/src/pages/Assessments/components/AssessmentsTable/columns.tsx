...
export const useColumns = (type: IAssessmentType) => {
  if (type === 'kyb_and_ownership') {
    return useMemo(
      () => [
        ...
        columnHelper.accessor('status', {
          cell: info => {
            ...
            return <AssessmentStatus status={status} assessmentId={info.row.original.id} />;
          },
          header: 'Status',
        }),
      ],
