...
export type Serializable = string | number | boolean | null | undefined | Array<Serializable> | {
...
export interface WorkflowOptionsBrowser extends Omit<WorkflowOptions, 'workflowActions' | 'workflowActors'> {
    backend?: DeepPartial<BackendOptions>;
    persistStates?: Array<string>;
}
export type BrowserWorkflowEvent = typeof Event.USER_NEXT_STEP | typeof Event.USER_PREV_STEP | typeof Event.STATE_ACTION_STATUS | typeof Error.ERROR | typeof Error.HTTP_ERROR | typeof Event.WILD_CARD | string;
...
export type CreateWorkflow = (options: Omit<WorkflowOptionsBrowser, 'workflowActions' | 'workflowActors'>) => InstanceType<typeof WorkflowBrowserSDK>;
