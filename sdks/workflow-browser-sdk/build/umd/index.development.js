...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WorkflowBrowserSDK = {}));
  ...
  ***************************************************************************** */
  ...
  var _subscription = /*#__PURE__*/_classPrivateFieldLooseKey$1("__subscription");
  var _workflow = /*#__PURE__*/_classPrivateFieldLooseKey$1("__workflow");
  var _currentStateNode = /*#__PURE__*/_classPrivateFieldLooseKey$1("__currentStateNode");
  var _currentState = /*#__PURE__*/_classPrivateFieldLooseKey$1("__currentState");
  var _context = /*#__PURE__*/_classPrivateFieldLooseKey$1("__context");
  var _callback = /*#__PURE__*/_classPrivateFieldLooseKey$1("__callback");
  var _extensions = /*#__PURE__*/_classPrivateFieldLooseKey$1("__extensions");
  var _debugMode = /*#__PURE__*/_classPrivateFieldLooseKey$1("__debugMode");
  var _extendedWorkflow = /*#__PURE__*/_classPrivateFieldLooseKey$1("__extendedWorkflow");
  var WorkflowRunner = /*#__PURE__*/function () {
    function WorkflowRunner(_ref, debugMode) {
      ...
      _classPrivateFieldLooseBase$1(this, _workflow)[_workflow] = _classPrivateFieldLooseBase$1(this, _extendedWorkflow)[_extendedWorkflow]({
      ...
      _classPrivateFieldLooseBase$1(this, _context)[_context] = Object.keys(_context2).length ? _context2 : workflowDefinition.context || {};

      // use initial state or provided state
      _classPrivateFieldLooseBase$1(this, _currentState)[_currentState] = _state ? _state : workflowDefinition.initial;

      // global and state specific extensions
      _classPrivateFieldLooseBase$1(this, _extensions)[_extensions] = _extensions2 || {
        globalPlugins: [],
        statePlugins: []
      };
      _classPrivateFieldLooseBase$1(this, _debugMode)[_debugMode] = debugMode;
    }
    var _proto = WorkflowRunner.prototype;
    _proto.sendEvent = /*#__PURE__*/function () {
      var _sendEvent = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee(event) {
        var _this = this;
        var workflow, service, _iterator, _step, ext, _iterator2, _step2, _ext;
        return _regeneratorRuntime$1().wrap(function _callee$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              workflow = _classPrivateFieldLooseBase$1(this, _workflow)[_workflow].withContext(_classPrivateFieldLooseBase$1(this, _context)[_context]);
              console.log('Current state:', _classPrivateFieldLooseBase$1(this, _currentState)[_currentState]);
              service = interpret(workflow).start(_classPrivateFieldLooseBase$1(this, _currentState)[_currentState]).onTransition(function (state) {
                if (state.changed) {
                  ...
                  if (_classPrivateFieldLooseBase$1(_this, _callback)[_callback]) {
                    ...
                    _classPrivateFieldLooseBase$1(_this, _callback)[_callback](_extends$1({}, event, {
                      state: name
                    }));
                  }
                }
                _classPrivateFieldLooseBase$1(_this, _currentStateNode)[_currentStateNode] = state;
                _classPrivateFieldLooseBase$1(_this, _currentState)[_currentState] = state.value;
              }); // all sends() will be deferred until the workflow is started
              service.start();
              _iterator = _createForOfIteratorHelperLoose(_classPrivateFieldLooseBase$1(this, _extensions)[_extensions].globalPlugins);
            case 5:
              ...
              return ext.action({
                ...
                event: event,
                currentState: _classPrivateFieldLooseBase$1(this, _currentStateNode)[_currentStateNode]
              });
            case 10:
              _context3.next = 5;
              break;
            case 12:
              service.send(event);
              _classPrivateFieldLooseBase$1(this, _context)[_context] = service.getSnapshot().context;
              if (_classPrivateFieldLooseBase$1(this, _debugMode)[_debugMode]) {
                console.log('context:', _classPrivateFieldLooseBase$1(this, _context)[_context]);
              }
              _iterator2 = _createForOfIteratorHelperLoose(_classPrivateFieldLooseBase$1(this, _extensions)[_extensions].globalPlugins);
            case 16:
              ...
              _context3.next = 21;
              return _ext.action({
                context: _classPrivateFieldLooseBase$1(this, _context)[_context],
                event: event,
                currentState: _classPrivateFieldLooseBase$1(this, _currentStateNode)[_currentStateNode]
              });
            case 21:
    ...
    _proto.subscribe = function subscribe(callback) {
      _classPrivateFieldLooseBase$1(this, _callback)[_callback] = callback;
      // Not currently in use.
      _classPrivateFieldLooseBase$1(this, _subscription)[_subscription].push(callback);
    };
    _proto.getSnapshot = function getSnapshot() {
      var service = interpret(_classPrivateFieldLooseBase$1(this, _workflow)[_workflow].withContext(_classPrivateFieldLooseBase$1(this, _context)[_context]));
      service.start(_classPrivateFieldLooseBase$1(this, _currentState)[_currentState]);
      return service.getSnapshot();
    };
    _createClass(WorkflowRunner, [{
      key: "workflow",
      get: function get() {
        return _classPrivateFieldLooseBase$1(this, _workflow)[_workflow];
      }
    }, {
      key: "state",
      get: function get() {
        return _classPrivateFieldLooseBase$1(this, _currentState)[_currentState];
      }
    }]);
  ...
  function _extendedWorkflow2(_ref2) {
    ...
    var _loop = function _loop() {
      ...
      for (var _iterator6 = _createForOfIteratorHelperLoose(statePlugin.stateNames), _step6; !(_step6 = _iterator6()).done;) {
        ...
        stateActions[statePlugin.name] = /*#__PURE__*/function () {
          var _ref5 = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee2(context, event) {
            var _classPrivateFieldLoo, _classPrivateFieldLoo2;
            var _classPrivateFieldLoo3, _classPrivateFieldLoo4, type, _classPrivateFieldLoo5, _classPrivateFieldLoo6;
            return _regeneratorRuntime$1().wrap(function _callee2$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  (_classPrivateFieldLoo = (_classPrivateFieldLoo2 = _classPrivateFieldLooseBase$1(_this2, _callback))[_callback]) == null ? void 0 : _classPrivateFieldLoo.call(_classPrivateFieldLoo2, {
                    type: 'STATE_ACTION_STATUS',
                    state: _classPrivateFieldLooseBase$1(_this2, _currentState)[_currentState],
                    payload: {
                      status: 'PENDING'
                    }
                  });
                  ...
                  return statePlugin.action({
                    context: context,
                    event: event,
                    currentState: _classPrivateFieldLooseBase$1(_this2, _currentState)[_currentState]
                  });
                case 4:
                  _context4.next = 16;
                  break;
                ...
                case 13:
                  ...
                  return _context4.abrupt("break", 15);
                case 15:
                  (_classPrivateFieldLoo3 = (_classPrivateFieldLoo4 = _classPrivateFieldLooseBase$1(_this2, _callback))[_callback]) == null ? void 0 : _classPrivateFieldLoo3.call(_classPrivateFieldLoo4, {
                    type: type,
                    state: _classPrivateFieldLooseBase$1(_this2, _currentState)[_currentState],
                    error: _context4.t0
                  });
                case 16:
                  _context4.prev = 16;
                  (_classPrivateFieldLoo5 = (_classPrivateFieldLoo6 = _classPrivateFieldLooseBase$1(_this2, _callback))[_callback]) == null ? void 0 : _classPrivateFieldLoo5.call(_classPrivateFieldLoo6, {
                    type: 'STATE_ACTION_STATUS',
                    state: _classPrivateFieldLooseBase$1(_this2, _currentState)[_currentState],
                    payload: {
                      status: 'IDLE'
    ...
    var actions = _extends$1({}, workflowActions, stateActions, {
      ping: function ping() {
    ...
    var guards = {
      'json-rule': function jsonRule(ctx, _ref3, _ref4) {
        ...
        var cond = _ref4.cond;
        var data = _extends$1({}, ctx, payload);
    ...
    return createMachine(_extends$1({
  ...
  var createWorkflow$1 = function createWorkflow(_ref) {
    var workflowDefinition = _ref.workflowDefinition,
  ...
  var WorkflowBrowserSDK = /*#__PURE__*/function () {
    function WorkflowBrowserSDK(_ref) {
      ...
      _classPrivateFieldLooseBase(this, _service)[_service] = createWorkflow$1(_extends({}, options, {
        extensions: {
          statePlugins: [{
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 14:
                      ...
                      throw _context.t0;
                    case 18:
                      throw new HttpError(_context.t0.status, "Response error: " + _context.t0.statusText + " (" + _context.t0.status + ")", {
                        cause: _context.t0
                      });
                    case 19:
                    case "end":
  ...
  var createWorkflow = function createWorkflow(options) {
    return new WorkflowBrowserSDK(options);
  };
