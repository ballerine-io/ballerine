  ...
  ***************************************************************************** */
  ...
  var WorkflowRunner = /*#__PURE__*/function () {
    function WorkflowRunner(_ref, debugMode) {
      ...
      _classPrivateFieldLooseBase(this, _context)[_context] = Object.keys(context).length ? context : workflowDefinition.context || {};
  ...
  function _extendedWorkflow2(_ref2) {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose(extensions.statePlugins), _step3; !(_step3 = _iterator3()).done;) {
      ...
      for (var _iterator4 = _createForOfIteratorHelperLoose(statePlugin.stateNames), _step4; !(_step4 = _iterator4()).done;) {
        var stateName = _step4.value;
  ...
  var _subscribers = /*#__PURE__*/_classPrivateFieldLooseKey$1("__subscribers");
  var _service = /*#__PURE__*/_classPrivateFieldLooseKey$1("__service");
  var _backendOptions = /*#__PURE__*/_classPrivateFieldLooseKey$1("__backendOptions");
  var _notify = /*#__PURE__*/_classPrivateFieldLooseKey$1("__notify");
  var _injectUserStepActionsToStates = /*#__PURE__*/_classPrivateFieldLooseKey$1("__injectUserStepActionsToStates");
  var WorkflowBrowserSDK = /*#__PURE__*/function () {
    function WorkflowBrowserSDK(_ref) {
      ...
      _classPrivateFieldLooseBase$1(this, _backendOptions)[_backendOptions] = _extends$1({}, backendOptions, backend, {
        endpoints: {
          persist: _extends$1({}, backendOptions.endpoints.persist, backend == null ? void 0 : (_backend$endpoints = backend.endpoints) == null ? void 0 : _backend$endpoints.persist),
          submit: _extends$1({}, backendOptions.endpoints.submit, backend == null ? void 0 : (_backend$endpoints2 = backend.endpoints) == null ? void 0 : _backend$endpoints2.submit)
        },
        headers: _extends$1({}, backendOptions.headers, backend == null ? void 0 : backend.headers)
      });

      // Actions defined within the machine's `states` object.
      var _states = _classPrivateFieldLooseBase$1(this, _injectUserStepActionsToStates)[_injectUserStepActionsToStates]((_options$workflowDefi = options == null ? void 0 : (_options$workflowDefi2 = options.workflowDefinition) == null ? void 0 : _options$workflowDefi2.states) != null ? _options$workflowDefi : {});
      // const states = this.#__injectSubmitActorToStates(states);

      // Actions defined within `createMachine`'s second argument (config object).

      _classPrivateFieldLooseBase$1(this, _service)[_service] = createWorkflow$1(_extends$1({}, options, {
        extensions: {
          statePlugins: [{
            ...
            when: 'entry',
            action: function () {
              var _action = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee(_ref2) {
                ...
                return _regeneratorRuntime$1().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _classPrivateFieldLoo = _classPrivateFieldLooseBase$1(_this, _backendOptions)[_backendOptions], baseUrl = _classPrivateFieldLoo.baseUrl, endpoints = _classPrivateFieldLoo.endpoints, headers = _classPrivateFieldLoo.headers;
        ...
        workflowDefinition: _extends$1({}, options == null ? void 0 : options.workflowDefinition, {
          states: _states
        }),
        workflowActions: (_workflowActions = {}, _workflowActions[Action.USER_NEXT_STEP] = assign(function (context, event) {
          context = _extends$1({}, context, event.payload);
          return context;
      ...
      _classPrivateFieldLooseBase$1(this, _service)[_service].subscribe(function (event) {
        _classPrivateFieldLooseBase$1(_this, _notify)[_notify](event);
      });
    }
    var _proto = WorkflowBrowserSDK.prototype;
    _proto.subscribe = function subscribe(event, cb) {
      _classPrivateFieldLooseBase$1(this, _subscribers)[_subscribers].push({
        event: event,
        cb: cb
      });
    };
    _proto.sendEvent = function sendEvent(event) {
      _classPrivateFieldLooseBase$1(this, _service)[_service].sendEvent(event);
    };
    _proto.getSnapshot = function getSnapshot() {
      return _classPrivateFieldLooseBase$1(this, _service)[_service].getSnapshot();
    };
  ...
  function _notify2(_ref3) {
    var type = _ref3.type,
      ...
      state = _ref3.state;
    _classPrivateFieldLooseBase$1(this, _subscribers)[_subscribers].forEach(function (sub) {
  ...
  function _injectUserStepActionsToStates2(states) {
    ...
    var reduceStateOnProp = function reduceStateOnProp(_ref4) {
      ...
      var on = (_Object$entries = Object.entries((_outerValue$on = outerValue == null ? void 0 : outerValue.on) != null ? _outerValue$on : {})) == null ? void 0 : _Object$entries.reduce(function (state, _ref5) {
        ...
        state[event] = _extends$1({}, eventProps, !(eventProps != null && eventProps.invoke) ? {
          actions: actions
        } : {});
        return state;
      }, {});
      ...
      // i.e. { WELCOME: { ..., on: { ... }, ... } }
      var injected = _extends$1({}, outerValue, Object.keys(on).length ? {
        on: on
      } : {});
