...
import { WorkflowContext } from "@ballerine/workflow-core";
...
export const createNodeWorkflow: TCreateNodeWorkflow = ({WorkflowDefType, workflowDefinition, context, extensions}) => {
  return {
